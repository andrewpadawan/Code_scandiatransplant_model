...
def generate_donor(total_samples, min_timestep, max_timestep, output_filepath):
    ...
    # Make my pandas df
    headers = ['DONORNUMBER', 'AB0_BLOOD_GROUP', 'RHESUS_CODE', 'GRAFT_TYPE',"AGE", "CITY", "COUNTRY", "TIMESTEP_ENTERED", "Genomic_HLA-A","Genomic_HLA-B","Genomic_HLA-C","Genomic_HLA-DRB1","Genomic_HLA-DQA1","Genomic_HLA-DQB1","Genomic_HLA-DPA1" ,"Genomic_HLA-DPB1","Serologic_HLA-A","Serologic_HLA-B","Serologic_HLA-C","Serologic_HLA-DRB1","Serologic_HLA-DQA1","Serologic_HLA-DQB1","Serologic_HLA-DPA1" ,"Serologic_HLA-DPB1",'Notes']
