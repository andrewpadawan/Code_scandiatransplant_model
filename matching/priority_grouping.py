...
from priority_ordering import *


def cascading_priority_allocation(recipient_df, organ):
    priority_1= check_priority_1(recipient_df, organ)
    if not priority_1.empty:
        ordered_priority_1= ordering_priority_1(priority_1)
        return ordered_priority_1
    
    priority_2= check_priority_2(recipient_df, organ)
    if not priority_2.empty:
        return priority_2
    
    priority_3= check_priority_3(recipient_df, organ)
    if not priority_3.empty:
        return priority_3
    
    priority_4= check_priority_4(recipient_df, organ)
    if not priority_4.empty:
        return priority_4
    
    priority_5= check_priority_5(recipient_df, organ)
    if not priority_5.empty:
        return priority_5
    priority_6= check_priority_6(recipient_df, organ)
    if not priority_6.empty:
        return priority_6
    priority_7= check_priority_7(recipient_df, organ)
...
def check_priority_1(recipient_df, organ):
    ...
    for idx, recipient_row in recipient_df.iterrows():
        ...
        valid_indices.append(idx).append(recipient_row)
...
def check_priority_2(recipient_df, organ):
...
def check_priority_3(recipient_df, organ):
...
def check_priority_4(recipient_df, organ):
    ...
    under_16_hla_a_b_under_2_mismatch= filter_priority_4_compatible(organ, abo_identical_df)
    # Return a DataFrame of all valid recipients
    return under_16_hla_a_b_under_2_mismatch


def check_priority_5(recipient_df, organ= Organ):
    valid_indices= []
...
def check_priority_6(recipient_df, organ= Organ):
...
def check_priority_7(recipient_df, organ= Organ):
